...
class String_p(Protocol):
    ...
    def endswith(self, suffix: str | tuple[str, ...], start: SupportsIndex | None = ..., end: SupportsIndex | None = ..., /,
    ) -> bool: ...
    ...
    def splitlines(self: LiteralString, keepends: bool = False) -> list[LiteralString]: ...  # noqa: FBT001, FBT002
