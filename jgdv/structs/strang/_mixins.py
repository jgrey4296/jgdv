...
from ._interface import StrangMarker_e, GEN_K, INST_K, Strang_p
...
class _Strang_cmp_m:
    ...
    def __lt__(self:Strang_p, other:object) -> bool:
        match other:
    ...
    def __le__(self:Strang_p, other:object) -> bool:
        match other:
            case Strang_p() as x:
...
class _Strang_format_m:
    ...
    def _format_subval(self:Strang_p, val:str, *, no_expansion:bool=False) -> str:
        match val:
            case str():
                return val
    ...
    def _expanded_str(self:Strang_p, *, stop:Maybe[int]=None) -> str:
    ...
    def __format__(self:Strang_p, spec:str) -> str:
...
class _Strang_validation_m:
    ...
    @classmethod
    def pre_process(cls:Strang_p, data:str, *, strict:bool=False) -> str:  # noqa: ARG003
    ...
    def _process(self:Strang_p) -> None:
    ...
    def _get_slices(self:Strang_p, start:int=0, max:Maybe[int]=None, *, add_offset:bool=False) -> list[slice]:  # noqa: A002
...
class _Strang_subgen_m:
    ...
    @classmethod
    def _subjoin(cls:type[Strang_p], lst:list) -> str:
        return cls._subseparator.join(lst)

    def canon(self:Strang_p) -> Strang_p:
    ...
    def pop(self:Strang_p, *, top:bool=False) -> Strang_p:
        """
        ...
        return cast("Strang_p", self[2:end_id])

    def push(self:Strang_p, *vals:str) -> Strang_p:
    ...
    def to_uniq(self:Strang_p, *, suffix:Maybe[str]=None) -> Strang_p:
    ...
    def de_uniq(self:Strang_p) -> Strang_p:
        ...
        if GEN_K not in self.metadata:
            return self
        return cast("Strang_p", self[2:self.metadata.get(INST_K, None)]).pop()

    def with_head(self:Strang_p) -> Strang_p:
    ...
    def root(self:Strang_p) -> Strang_p:
