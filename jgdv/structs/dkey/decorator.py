...
class DKeyExpansionDecorator(DataDecorator):
    ...
    def __init__(self, keys:list[DKey], ignores:None|list[str]=None, **kwargs):
    ...
    def _verify_signature(self, sig:inspect.Signature, ttype:_TargetType_e, args:list[DKey]) -> None:
        # Get the head args
        match ttype:
